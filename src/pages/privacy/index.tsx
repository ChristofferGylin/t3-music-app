    ...
    <main className="flex h-full w-full items-center justify-center bg-slate-900">
      <div>
        ...
        <p>
          ...
          use, and protect your information when you use our web application. By
          using PlinkPlonk, you agree to the terms outlined in this Privacy
          Policy.
        </p>
        ...
        <p>
          ...
          including your usage patterns, preferences, and other analytics data.
        ...
        <p>
          Your music projects are stored securely in our database to ensure that
          you can access and manage them seamlessly.
        </p>
        <h3>Analytics</h3>
        <p>
        ...
        <p>
          ...
          other purposes. These services may collect information as governed by
          their respective privacy policies. We recommend reviewing the privacy
        ...
        <p>
          <span className="font-bold">Thank you for using PlinkPlonk!</span>
        </p>
      </div>
    </main>
  );
